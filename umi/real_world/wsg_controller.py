    ...
    def run(self):
        ...
        try:
            with WSGBinaryDriver(
                ...
                # get initial
                curr_info = wsg.script_query()  # 상태 정보를 요청하여 반환
                curr_pos = curr_info['position']    # 최대 개방 폭 (Maximum Width): 110mm (0.11m), 최소 닫힘 폭 (Minimum Width): 0mm
                # curr_pos = 100.0
                ...
                while keep_running:
                    ...
                    # 특정 위치(target_pos)와 속도(target_vel)를 목표로 그리퍼를 제어하는 명령을 하드웨어로 전송
