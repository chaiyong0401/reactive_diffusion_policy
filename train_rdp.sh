...
# AT_LOAD_DIR="/home/dyros-recruit/mcy_ws/reactive_diffusion_policy_umi/data/outputs/2025.05.13/15.10.18_train_vae_real_umi_image_gelsight_emb_at_24fps_0513151017/checkpoints/latest.ckpt"
...
# TASK_NAME="peel"
# # DATASET_PATH="/home/dyros-recruit/mcy_ws/reactive_diffusion_policy_umi/reactive_diffusion_policy_dataset/dataset_mini/peel_v3_downsample1_zarr"
# DATASET_PATH="/home/dyros-recruit/mcy_ws/reactive_diffusion_policy_umi/reactive_diffusion_policy_dataset/dataset_mini/peel_v3_downsample1_zarr/replay_buffer.zarr"
# LOGGING_MODE="online"
...
# echo "Searching for the latest AT checkpoint..."
# # AT_LOAD_DIR=$(find "${SEARCH_PATH}" -maxdepth 2 -path "*${TIMESTAMP}*" -type d)/checkpoints/latest.ckpt
# AT_LOAD_DIR='/home/dyros-recruit/mcy_ws/reactive_diffusion_policy_umi/data/outputs/2025.05.13/21.33.04_train_vae_real_peel_image_gelsight_emb_at_24fps_0513213303/checkpoints/latest.ckpt'
# if [ ! -f "${AT_LOAD_DIR}" ]; then
#     echo "Error: VAE checkpoint not found at ${AT_LOAD_DIR}"
#     exit 1
# fi
